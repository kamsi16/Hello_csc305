...
pub(crate) fn boolean(){
        let fat = true;// defined boolean variable
        if fat != true{
                println!("I am not fat.cap*!"); // prints "I am not hungry!"
        }else {
                println!("I am fat!!!!");
        }
}

pub(crate) fn integer_example() {
        ...
        println!("Signed float: {}", c);
       
}
    
pub(crate) fn textual_examples(){
        let name="Kamsi";
        let blood_type="AB";
