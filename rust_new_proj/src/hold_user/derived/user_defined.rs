...
#[derive(Debug, PartialEq, PartialOrd)] // Derive Debug, PartialEq, and PartialOrd traits
pub struct Rect {
    length: i32,
    width: i32,
    name: &'static str,
...
impl Rect {
    // Associated function to create a new Rect
    pub fn new(length: i32, width: i32, name: &'static str) -> Self {
...
// Now let's define a Circle struct
#[derive(Debug, PartialEq, PartialOrd)] // Derive Debug, PartialEq, and PartialOrd traits
pub struct Circle {
    radius: f64,
}
...
// Lastly, let's define a Triangle struct
#[derive(Debug, PartialEq, PartialOrd)] // Derive Debug, PartialEq, and PartialOrd traits
pub struct Triangle {
    side_a: f64,
    side_b: f64,
...
impl Triangle {
    // Associated function to create a new Triangle
